    ...
    function pollReport(futureId){
        return $q(function(resolve,reject){
            window.GTNXReport.poll(function(response){
                ...
                reject(error);
            }, globals.applicationHostName ,    //SERVER Variable set in App.js
                authToken,                      //Authtoken set after Login
                globals.dataKey,                //Datakey set in App.js
                reportId,                       //UID of report on GTN System
                futureId, "");                  //FutureId set from Execute POST, last param is filePath in which to save the report - currently not functional
        })
    }
